    ...
    <div className="bg-[#6e07f3] flex flex-col items-center w-full">
      ...
      <div className="flex flex-row items-center justify-center">
        <p className="text-white lg:text-2xl text-sm font-semibold px-[2.4rem] py-[2.4rem] w-full lg:w-[60rem] xl:w-[70rem] text-center">
          "I’m a full-stack developer passionate about building scalable and user-friendly applications. I enjoy solving complex problems, optimizing systems, and creating efficient digital solutions."
        </p>
      </div>
      <div className="p-3">
        <a
